...
if (require.main === module) {
  ...
  if (args.length === 0) {
    console.log('ใช้งาน: node fetch-screenshot.js <url> [width] [height] [fullPage] [outputPath]');
    console.log('ตัวอย่าง:');
    console.log('  node fetch-screenshot.js https://google.com');
    console.log('  node fetch-screenshot.js https://google.com 1280 720 true my-screenshot.png');
    process.exit(1);
  }
